...
st.markdown("""
<style>
/* 1. FORCE THE SIDEBAR TOGGLE ARROWS TO STAND OUT ON THE DARK BACKGROUND */
[data-testid="stHeader"] {
    background-color: transparent !important;
}

/* Target the native sidebar open/close buttons and make them glowing pink and highly visible */
